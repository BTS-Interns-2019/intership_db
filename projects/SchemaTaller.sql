...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Cliente` ;
...
-- Table `taller`.`Anio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Anio` ;

CREATE TABLE IF NOT EXISTS `taller`.`Anio` (
...
-- Table `taller`.`Marca`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Marca` ;

CREATE TABLE IF NOT EXISTS `taller`.`Marca` (
...
-- Table `taller`.`Modelo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Modelo` ;

CREATE TABLE IF NOT EXISTS `taller`.`Modelo` (
  ...
  CONSTRAINT `fk_Modelo_Marca1`
    ...
    REFERENCES `taller`.`Marca` (`idMarca`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Vehiculo` ;
...
CREATE TABLE IF NOT EXISTS `taller`.`Vehiculo` (
  ...
  CONSTRAINT `fk_Vehiculo_Cliente`
    ...
    REFERENCES `taller`.`Cliente` (`idCliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Vehiculo_Modelo1`
    FOREIGN KEY (`Modelo_idModelo`)
    REFERENCES `taller`.`Modelo` (`idModelo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `taller`.`Estado`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Estado` ;

CREATE TABLE IF NOT EXISTS `taller`.`Estado` (
...
-- -----------------------------------------------------
-- Table `taller`.`Servicio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Servicio` ;

CREATE TABLE IF NOT EXISTS `taller`.`Servicio` (
  ...
  CONSTRAINT `fk_Servicio_Estado1`
    ...
    REFERENCES `taller`.`Estado` (`idEstado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `taller`.`vehiculo_servicio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`vehiculo_servicio` ;

CREATE TABLE IF NOT EXISTS `taller`.`vehiculo_servicio` (
  ...
  CONSTRAINT `fk_vehiculo_servicio_Vehiculo1`
    ...
    REFERENCES `taller`.`Vehiculo` (`idVehiculo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vehiculo_servicio_Servicio1`
    FOREIGN KEY (`Servicio_idServicio`)
    REFERENCES `taller`.`Servicio` (`idServicio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `taller`.`CostoManoObra`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`CostoManoObra` ;

CREATE TABLE IF NOT EXISTS `taller`.`CostoManoObra` (
  `idCostoManoObra` INT UNSIGNED NULL,
  `CostoManoObra` DECIMAL(3,2) UNSIGNED NOT NULL,
  `Fecha` DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table `taller`.`Mecanico`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Mecanico` ;
...
CREATE TABLE IF NOT EXISTS `taller`.`Mecanico` (
  ...
  CONSTRAINT `fk_Mecanico_CostoManoObra1`
    ...
    REFERENCES `taller`.`CostoManoObra` (`idCostoManoObra`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `taller`.`Mecanico_Servicio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Mecanico_Servicio` ;

CREATE TABLE IF NOT EXISTS `taller`.`Mecanico_Servicio` (
  `Servicio_idServicio` INT NOT NULL,
  ...
  CONSTRAINT `fk_Mecanico_Servicio_Mecanico1`
    ...
    REFERENCES `taller`.`Mecanico` (`idMecanico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Proveedor` ;
...
-- -----------------------------------------------------
-- Table `taller`.`Refaccion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Refaccion` ;

CREATE TABLE IF NOT EXISTS `taller`.`Refaccion` (
...
-- -----------------------------------------------------
-- Table `taller`.`Proveedor_Refaccion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Proveedor_Refaccion` ;

CREATE TABLE IF NOT EXISTS `taller`.`Proveedor_Refaccion` (
  ...
  CONSTRAINT `fk_Proveedor_Refaccion_Refaccion1`
    ...
    REFERENCES `taller`.`Refaccion` (`idRefaccion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `taller`.`Movimientos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Movimientos` ;

CREATE TABLE IF NOT EXISTS `taller`.`Movimientos` (
  `idMovimientos` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `tipoMovimiento` ENUM('ENTRADA', 'SALIDA') NOT NULL,
  `cantidad` INT NOT NULL,
  `costos` DECIMAL(3,2) UNSIGNED NOT NULL,
  `fecha` DATE NOT NULL,
  `Proveedor_Refaccion_id` INT UNSIGNED NOT NULL,
  `Mecanico_idMecanico` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_Movimientos_Proveedor_Refaccion1`
    ...
    REFERENCES `taller`.`Proveedor_Refaccion` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `taller`.`Servicio_Factura`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `taller`.`Servicio_Factura` ;

CREATE TABLE IF NOT EXISTS `taller`.`Servicio_Factura` (
  `Servicio_idServicio` INT NOT NULL,
